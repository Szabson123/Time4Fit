...
def test_daily_meal_calendar_returns_water_and_kcal_together(auth_api_client):
    ...
    # 1. Nonexistent day -> returns water_intake_ml 0 along with kcal 0.00
    ...
    # Calendar endpoint should now return 250ml water, 0.00 kcal, and 5 empty meal slots
    ...
    # Calendar endpoint returns combined kcal, nutrients, meals, and water!
